...
<div class="box wow fadeIn">
    <div class="box-header">
        <h3 class="box-title">Danh sách ID VIP Cảm Xúc <?php if($rule == 'admin' || $rule == 'agency'){ ?>  <a class="btn btn-danger" href="index.php?DS=CTV_Like" target="_blank">VIP Cảm Xúc CTV</a><?php } ?></h3>
