    ...
    if(isset($_POST['submit'])){
        ...
        if(mysqli_query($conn, $update)){
            ...
            if(mysqli_query($conn, $his)){
             echo "<script>alert('Cập nhật thông tin thành công'); window.location='dai-li.html';</script>";
            }
        }
    }
}
        ...
        <div class="box box-info wow fadeIn">
            ...
            <form class="form-horizontal" action="#" method="post">
                ...
                <div class="box-footer">
                    <?php if($rule != 'admin'){ ?><font color="red"><b>Để đổi Username & Email Liên hệ <a href="//fb.com/duysexy98" target="_blank"><b>Admin</b></a></b></font> <?php } ?>
